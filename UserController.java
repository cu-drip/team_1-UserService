...
public class UserController {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Пользователь найден (теперь с mmr)", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.example.userservice.dto.UserResponse.class))),
